                ...
                <form>
                 {users.map((user, keys) => {
                    return <div key={keys}>
                      ...
                      <h6>Skill Set</h6>
                      {user.skills.map((skill, keys)=>{
                        return <div className='my-2' key={keys}>

                           <input className='form-control' placeholder='Skill Name' value={skill.skillName} />
                           <input className='form-control mt-2' placeholder='Experience' value={skill.exp} />
